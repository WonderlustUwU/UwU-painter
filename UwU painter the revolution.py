...
class Paint(object):
    ...
    def __init__(self, partner):
        ...
        # title bar frame to act as new title bar that can be customised
        ...
        # frame for all the main affect buttons
        ...
        # same for all buttons, uses backgorund of buttons,
        # the text of buttons, makes button sunken when in use and
        ...
        self.file_saved = Label(self.topbar, bg='azure4',
                                fg='azure2', text='',
                                borderwidth=1,
                                font='fixedsys 12 bold')
        self.file_saved.grid(row=0, column=11, padx=10)
    ...
    def save_file(self):
        ...
        self.file_saved.configure(text='File saved as UwU_image(' + str(
            num_img) + ').png')
...
class Help:
    def __init__(self, partner):
        ...
        self.help_explain = Label(self.helpbox,
                                  ...
                                  ' \n\n Undo: remove the last line drawn   '
                                  '( Ct'
                                  'rl + Z) \n\n Clear: era'
